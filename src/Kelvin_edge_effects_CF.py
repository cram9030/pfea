...
def calcDisplacement(size_x,size_y,size_z,vox_pitch,force):
    ...
    for x in range(1,size_x+1):
   	for y in range(1,size_y+1):
  		...
  		#rotate
  		constraints.append({'node':node_frame_map[x][y][1][5],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][5],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][5],'DOF':2, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][5],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][5],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][5],'DOF':5, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':2, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][10],'DOF':5, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':2, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][12],'DOF':5, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':2, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][1][17],'DOF':5, 'value':0})
                #The top most nodes are assigned a z-axis load, as well as being
                #constrained to translate in only the z-direction.
                loads.append(      {'node':node_frame_map[x][y][size_z][6],'DOF':2, 'value':force})
                constraints.append({'node':node_frame_map[x][y][size_z][6],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][6],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][6],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][6],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][6],'DOF':5, 'value':0})
                loads.append(      {'node':node_frame_map[x][y][size_z][11],'DOF':2, 'value':force})
                constraints.append({'node':node_frame_map[x][y][size_z][11],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][11],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][11],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][11],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][11],'DOF':5, 'value':0})
                loads.append(      {'node':node_frame_map[x][y][size_z][13],'DOF':2, 'value':force})
                constraints.append({'node':node_frame_map[x][y][size_z][13],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][13],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][13],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][13],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][13],'DOF':5, 'value':0})
                loads.append(      {'node':node_frame_map[x][y][size_z][18],'DOF':2, 'value':force})
                constraints.append({'node':node_frame_map[x][y][size_z][18],'DOF':0, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][18],'DOF':1, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][18],'DOF':3, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][18],'DOF':4, 'value':0})
                constraints.append({'node':node_frame_map[x][y][size_z][18],'DOF':5, 'value':0})
