...
constraints.append({'node':node_frame_map[1][1][1][1],'DOF':1, 'value':0})
loads.append({'node':node_frame_map[1][1][1][3],'DOF':2, 'value':force})
#loads.append({'node':node_frame_map[1][2][2][3],'DOF':3, 'value':force})
#loads.append({'node':node_frame_map[2][1][2][3],'DOF':3, 'value':force})
#loads.append({'node':node_frame_map[2][2][2][3],'DOF':3, 'value':force})
#loads.append({'node':node_frame_map[1][1][3][3],'DOF':3, 'value':-force})
#loads.append({'node':node_frame_map[1][2][3][3],'DOF':3, 'value':-force})
#loads.append({'node':node_frame_map[2][1][3][3],'DOF':3, 'value':-force})
#loads.append({'node':node_frame_map[2][2][3][3],'DOF':3, 'value':-force})
